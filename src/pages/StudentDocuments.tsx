...
const StudentDocuments = () => {
  ...
  const fetchDriveContents = useCallback(async (parentId: number | null) => {
    ...
    try {
      ...
      const url = `[https://quanlydaythem-api.onrender.com](https://quanlydaythem-api.onrender.com)/api/folders/drive?category=STORAGE&class_id=${classId}` + (parentId ? `&parent_id=${parentId}` : '');
