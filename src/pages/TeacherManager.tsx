...
const TeacherManager = () => {
  ...
  const fetchTeachers = async () => {
    try {
      ...
      const res = await axios.get('[https://quanlydaythem-api.onrender.com](https://quanlydaythem-api.onrender.com)/api/auth/teachers', {
  ...
  const handleCreateTeacher = async (e: React.FormEvent) => {
    ...
    try {
      const token = localStorage.getItem('token');
      await axios.post('[https://quanlydaythem-api.onrender.com](https://quanlydaythem-api.onrender.com)/api/auth/teachers', {
        username,
        password,
        full_name: fullName
      }, {
  ...
  const handleResetPassword = async (teacherId: number, teacherName: string) => {
    ...
    try {
      const token = localStorage.getItem('token');
      await axios.put(`[https://quanlydaythem-api.onrender.com](https://quanlydaythem-api.onrender.com)/api/auth/teachers/${teacherId}/reset-password`, 
