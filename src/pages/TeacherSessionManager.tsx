...
const TeacherSessionManager = () => {
  ...
  const fetchClasses = async () => {
    ...
    try {
      const res = await axios.get('[https://quanlydaythem-api.onrender.com](https://quanlydaythem-api.onrender.com)/api/classes', {
  ...
  const fetchSessions = useCallback(async () => {
    ...
    const token = localStorage.getItem('token');
    try {
      const res = await axios.get(`[https://quanlydaythem-api.onrender.com](https://quanlydaythem-api.onrender.com)/api/sessions?class_id=${selectedClassId}`, {
        headers: { Authorization: `Bearer ${token}` }
      });
  ...
  const handleDeleteRow = async (index: number, sessionId?: number) => {
    ...
    if (sessionId) {
      const token = localStorage.getItem('token');
      try {
        await axios.delete(`[https://quanlydaythem-api.onrender.com](https://quanlydaythem-api.onrender.com)/api/sessions/${sessionId}`, {
          headers: { Authorization: `Bearer ${token}` }
        });
      } catch (error) {
  ...
  const handleSaveDraft = async () => {
    ...
    try {
      await Promise.all(sessions.map(session => {
        return axios.post('[https://quanlydaythem-api.onrender.com](https://quanlydaythem-api.onrender.com)/api/sessions/upsert', {
          ...session,
  ...
  const handlePublish = async () => {
    ...
    const token = localStorage.getItem('token');
    try {
      await axios.post('[https://quanlydaythem-api.onrender.com](https://quanlydaythem-api.onrender.com)/api/sessions/publish', {
